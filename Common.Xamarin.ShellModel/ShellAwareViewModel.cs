...
{
    public class ShellAwareViewModel : BaseViewModel, IQueryAttributable
    {
        ...
        public void ApplyQueryAttributes(IDictionary<string, string> query)
        {
            ...
            if(lookup != null)
            {
                foreach(var pair in query)
                {
                    ...
                    {
                        //Store
                        var value = Uri.UnescapeDataString( query[pair.Key] );
        ...
        private static string Serialize<T>(T input)
        {
            ...
            {
                result = JsonConvert.SerializeObject(Uri.EscapeDataString(strInput));
